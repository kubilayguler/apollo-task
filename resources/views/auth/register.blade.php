...
<body class="m-0 min-h-screen bg-background-dark text-app-text antialiased flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl border border-border-dark bg-surface-dark/40 p-6 shadow-xl backdrop-blur-sm">
            ...
            @if ($errors->any())
                <div class="mb-4 rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-3 space-y-1">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <span
                            class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[18px] text-app-muted">person</span>
                ...
                <div>
                    <label
                        class="block mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-app-muted">Confirm
                        Password</label>
                    <div class="relative">
                        <span
                            class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[18px] text-app-muted">lock</span>
